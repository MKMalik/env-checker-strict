...
const argv = yargs(hideBin(process.argv))
  ...
  .option('comment', {
    ...
    type: 'boolean',
    default: true,
    description: 'Include standard comment block',
  })
  .option('ts', {
    type: 'boolean',
    default: false,
...
const envPath = path.resolve(process.cwd(), argv.input);
const isTs = argv.ts;
...
const commentBlock = argv.comment ? `
/**
...
fs.writeFileSync(outputPath, isTs ? tsGenerated : generated);
